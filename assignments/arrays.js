...
console.log(`id: ${inventory[32].id}, year: ${inventory[32].car_year}, make: ${inventory[32].car_make}, model: ${inventory[32].car_model}`);
...
let lastCar = 0;
console.log(`make: ${inventory[inventory.length - 1].car_make}, model: ${inventory[inventory.length - 1].car_model}`);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. Sort all the car model names into alphabetical order and log the results in the console
let carModels = [];

let inventorySorted = inventory.sort((car1, car2) => car1.car_model > car2.car_model)

carModels = inventorySorted.map(car => car.car_model)
